...
export function normalizePaperSubmission(item) {
    ...
    return {
        ...
        hasAcceptedFinalPaper: finalPaperSubmissions.some((paper) => paper.finalStatus === "accepted"),
        finalPaperPdf: finalPaperSubmissions.find((paper) => paper.finalStatus === "accepted")?.fullPaper ?? null,
    };
}
