...
export async function GET(request: NextRequest) {
    ...
    try {
        ...
        // 5. Get internal user ID for OTP verification flow
        let internalUserId = "";
        try {
        ...
        // 6. Redirect to OTP verification page (email-based OTP)
        ...
        console.log(`[AUTH] Redirecting ${email} to email OTP verification page`);
