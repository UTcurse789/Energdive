...
export default function InterviewPage() {
    ...
    useEffect(() => {
        async function fetchData() {
            try {
                const url = `${STRAPI_BASE_URL}/api/contents?filters[type_of_content][name][$eq]=Interview&populate=*&pagination[pageSize]=100&sort[0]=publishedAt:desc&sort[1]=Date:desc&sort[2]=createdAt:desc`;
