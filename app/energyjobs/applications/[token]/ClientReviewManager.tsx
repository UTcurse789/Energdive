                ...
                <div className="mt-5 space-y-4">
                  <div className="flex flex-col gap-4 rounded-2xl border border-[#09B697]/25 bg-[#09B697]/[0.02] p-5 sm:flex-row sm:items-center sm:justify-between">
                    ...
                    <a
                      ...
                      className="!inline-flex h-11 items-center justify-center gap-2 rounded-xl !bg-[#091d3a] px-5 text-sm font-bold !text-white shadow-sm transition-all duration-200 hover:!bg-[#09B697] hover:!text-white hover:shadow-md hover:shadow-[#09B697]/20"
                    >
