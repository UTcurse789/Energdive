                ...
                <div className="relative z-10 grid grid-cols-1 lg:grid-cols-12 gap-10 items-center">
                    ...
                    <div className="lg:col-span-8">
                        ...
                        <h2 className="text-4xl md:text-5xl font-black uppercase tracking-tighter text-white leading-tight mb-8">
                            The Definitive Voice of India’s<br />
                            Energy <span className="text-[#00A651] italic"> Transition.</span>
                        </h2>
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-start">
                            ...
                            <div className="space-y-4">
                                <p className="text-xs text-zinc-500 leading-relaxed italic">
                                    Positioned at the intersection of policy, enterprise, and innovation, ENERGDIVE will chronicle India’s decisive decade of transformation—spotlighting the reforms, investments, and breakthroughs shaping Oil & Gas, Power & Utilities, Renewables, New Energies, Sustainability, and Climate Action.
                                </p>
                                <p className="text-xs text-zinc-500 leading-relaxed italic">
                                    Its editorial architecture is designed to engage thought leaders and changemakers through:
                                </p>
                            </div>
                        </div>
                    </div>
      ...
      translate-y-2 group-hover:translate-y-0">
            ...
            <div className="mt-12 text-center border-t border-zinc-100 pt-8">
                <p className="text-sm font-serif italic text-zinc-400">
                    "Through a dual print and digital format, ENERGDIVE represents not just a magazine—but a knowledge movement for India’s sustainable energy future."
                </p>
            </div>
        </section>
    );
