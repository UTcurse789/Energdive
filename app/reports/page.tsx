...
export default function ReportsPage() {
  ...
  if (loading) return (
    <div className="min-h-screen bg-[#FDFDFD]">
      <Header />
      <div className="pt-20">
        <div className="w-full min-h-[340px] md:min-h-[420px] bg-zinc-900 flex items-center px-6 lg:px-12">
  ...
  return (
    <div className="min-h-screen bg-[#FDFDFD] font-sans text-zinc-900 overflow-x-hidden">
      <main className="relative pb-32">
        {/* HERO SECTION */}
        <section className="relative w-full min-h-[340px] md:min-h-[420px] flex items-center bg-[#0a0a0a] overflow-hidden">
          ...
          <div className="container mx-auto px-6 lg:px-12 max-w-[1400px] relative z-10 pt-20">
            <div className="flex flex-col gap-6 max-w-4xl">
              <motion.h1
                ...
                className="text-4xl sm:text-5xl md:text-7xl font-black uppercase text-[#00A651]"
              >
                Reports
              </motion.h1>
