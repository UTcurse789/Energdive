...
export function classifyContent(c: any): string | null {
...
export function extractText(blocks: any[]) {
    if (!blocks) return "";
    return blocks
...
export function getContentRoute(typeOfContent: any, contentTag?: any): string {
...
export function extractTypeOfContentName(typeOfContent: any): string | null {
...
export const PDF_POPULATE_PARAM = "populate[7]=issue_Epdf";

export function getPopulateParams(includeIssuePdf = true) {
...
export async function fetchIssueDetailWithFallback(id: number | string, includeIssuePdf = true): Promise<Response> {
    const STRAPI_TOKEN = process.env.STRAPI_API_TOKEN || "";
...
export function mapArticle(c: any) {
    const rawImage =
...
export function mapIssue(item: any, slug: string): Issue {
