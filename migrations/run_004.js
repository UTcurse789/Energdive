#!/usr/bin/env node
/**
 * Run migration 004: Add magic_token columns to users table.
 *
 * Usage:
 *   node migrations/run_004.js
 *
...
async function main() {
    ...
    try {
        const sqlPath = path.join(__dirname, "004_magic_token_columns.sql");
        ...
        const check = await pool.query(`
            ...
            WHERE table_name = 'users'
              AND column_name IN ('magic_token', 'magic_token_expires_at')
