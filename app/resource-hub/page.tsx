...
export const metadata: Metadata = {
  title: {
    absolute: "Resource Hub | ENERGDIVE",
  },
  description:
    "Browse ENERGDIVE magazines, post-show reports, whitepapers, presentations, media kits, and industry insights from leading energy events worldwide.",
  alternates: {
    canonical: "https://www.energdive.com/resource-hub",
  },
  openGraph: {
    title: "Resource Hub | ENERGDIVE",
    description:
      "Browse ENERGDIVE magazines, post-show reports, whitepapers, presentations, media kits, and industry insights from leading energy events worldwide.",
    url: "https://www.energdive.com/resource-hub",
    siteName: "ENERGDIVE",
    type: "website",
    images: [
      {
