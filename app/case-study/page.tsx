...
export default function CaseStudyPage() {
    ...
    useEffect(() => {
        async function fetchData() {
            try {
                const url = `${STRAPI_BASE_URL}/api/contents?filters[type_of_content][name][$eq]=Case Study&populate=*&pagination[pageSize]=100&sort[0]=publishedAt:desc&sort[1]=Date:desc&sort[2]=createdAt:desc`;
